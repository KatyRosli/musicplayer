...
export const Play = () => {
    return (
        <svg width="45" height="45" fill="#C353E6" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
export const SkipForward = () => {
    return (
        <svg width="28" height="28" fill="#6F759A" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
export const RandomMusicsFalse = () => {
    return (
        <svg width="25" height="25" fill="none" stroke="#6F759A" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
export const RandomMusicsTrue = () => {
    return (
        <svg width="25" height="25" fill="none" stroke="#C353E6" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
  <path d="m18 4 3 3-3 3"></path>
  <path d="m18 20 3-3-3-3"></path>
  <path d="M3 7h3a5 5 0 0 1 5 5 5 5 0 0 0 5 5h5"></path>
  <path d="M9 16.001c-.865.65-1.918 1-3 .999H3"></path>
...
export const VolumeOff = () => {
    return (
        <svg width="20" height="20" fill="#6F759A" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
export const Menu = () => {
    return (
        <svg width="28" height="28" fill="none" stroke="#7A049E" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
